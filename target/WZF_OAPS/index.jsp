...
<%--select * from article a , subject s where a.sid=s.sid  and subject="Computer Science" and hide="No";--%>
<%--</sql:query>--%>

<%--<sql:query var="medical" dataSource="${ db}">--%>
<%--select * from article a , subject s where a.sid=s.sid  and subject="Medical Science" and hide="No";--%>
<%--</sql:query>--%>

<%--<sql:query var="social" dataSource="${ db}">--%>
<%--select * from article a , subject s where a.sid=s.sid  and subject="Social Science" and hide="No";--%>
<%--</sql:query>--%>

<%--<sql:query var="biological" dataSource="${ db}">--%>
<%--select * from article a , subject s where a.sid=s.sid  and subject="Biological Science" and hide="No";--%>
<%--</sql:query>--%>

<%--<sql:query var="math" dataSource="${ db}">--%>
<%--select * from article a , subject s where a.sid=s.sid  and subject="Mathematics" and hide="No";--%>
<%--</sql:query>--%>
...
<div class="list-group">
    <c:forEach items="${subject.rows}" var="s_row">
        ...
        <a class="list-group-item" href="Controller?page=subject&id=${s_row.subject}"><c:out value="${s_row.subject}"></c:out></a>
