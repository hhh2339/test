...
<head>
<meta charset="UTF-8">
<title>View com.javaBean.Article</title>
...
<tr><td class="td1">com.javaBean.Author</td></tr>
...
<form action="Controller" method="post" class="popularity">
...
<input type="hidden" name="title" value="${ title}">
<table>
<tr><td> <input type="email" name="email"  value="${email}" hidden> </td></tr>
