...
<a href="Controller?page=admin">com.javaBean.Author</a>
...
select * from article where  hide="No" and title like '%<%=request.getAttribute("search2") %>%' or abstracts like '%<%=request.getAttribute("search2") %>%' or highlight like '%<%=request.getAttribute("search2") %>%' order by time desc
</sql:query>
